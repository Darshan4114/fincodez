...
export default function GoalTrackerPage({ userId }: { userId: string }) {
    ...
    const handleGrowthChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    return (
        <MainLayout>
            <main className="p-8 grow">
                <p className="text-xl">With right financial planning</p>
                <p className="text-5xl mb-10">Achieve your dreams</p>
                    ...
                    <div className=" h-screens grow">
                        <div className="">
                            <div className="flex flex-col gap-4">
                                ...
                                />
                                <DarkModeTextField
                                    label="Expected growth rate (in percentage)"
                                    name="growth"
                                    value={String(growth)}
            ...
            <div className='bg-neutral-700 w-72flex flex-col border-l border-neutral-500'>
                <div className="goals p-4 w-72">
                    ...
                    <div className="h-[30rem] overflow-y-scroll pr-2">
                        {goals?.length === 0 && <p>No goals yet!, Please create a goal!</p>}
