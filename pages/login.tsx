...
const ResendVerificationMessage = ({ resendVerificationMail, email }: any) => {
...
export default function Login({ loginRedirectUrl, ...props }: any) {
        ...
        signInWithEmailAndPassword(auth, data.email, data.password)
            .then((userCredential) => {
                ...
                if (!user.emailVerified) {
                    console.log('email not verifieds')
                    toast.error(
    ...
    return (
        <Container>
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <button type="submit" value="submit" className='my-2'>
                    Login
                </button>
            </Form>
            <p>or login with</p>
